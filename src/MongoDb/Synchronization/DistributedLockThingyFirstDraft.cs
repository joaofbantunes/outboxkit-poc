...
internal sealed partial class DistributedLockThingyFirstDraft(string key, IServiceProvider services)
{
            ...
            try
            {
                var result = await collection.DeleteOneAsync(
                    Builders<DistributedLockDocument>.Filter.And(
                        ...
                        Builders<DistributedLockDocument>.Filter.Eq(d => d.Owner, _baseDocument.Owner)));
